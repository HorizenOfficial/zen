...
class sc_cert_ceasing_sg(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #----------------------------------------------------------------------
        quality = 1
        proof = mcTest.create_test_proof("sc1", scid_swapped, epoch_number, quality, MBTR_SC_FEE, FT_SC_FEE, constant, epoch_cum_tree_hash, [pkh_node1], [bwt_amount_1])
        ...
        #----------------------------------------------------------------------
        quality = 1
        proof = mcTest.create_test_proof("sc1", scid_swapped, epoch_number, quality, MBTR_SC_FEE, FT_SC_FEE, constant, epoch_cum_tree_hash, [pkh_node1], [bwt_amount_2])
