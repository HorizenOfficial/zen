...
class sc_cert_quality_wallet(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            cert_epoch_0_1 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash,
        ...
        try:
            cert_epoch_0_2 = self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash,
        ...
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, 
        ...
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash,
                                                            proof, amount_cert_3, FT_SC_FEE, MBTR_SC_FEE, 3*CERT_FEE)
        ...
        try:
            cert_epoch_1_4 = self.nodes[0].send_certificate(scid, epoch_number, quality_h, epoch_block_hash, epoch_cum_tree_hash,
                                                            proof, amount_cert_4, FT_SC_FEE, MBTR_SC_FEE, 2*CERT_FEE)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
            assert(False)
        ...
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash,
                                                            proof, amount_cert_3, FT_SC_FEE, MBTR_SC_FEE, 2*CERT_FEE)
        ...
        try:
            cert_epoch_2_5 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, 
