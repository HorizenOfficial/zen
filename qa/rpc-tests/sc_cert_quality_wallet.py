...
class sc_cert_quality_wallet(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            cert_epoch_0_1 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_1, FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
        ...
        try:
            cert_epoch_0_2 = self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_2, FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
        except JSONRPCException, e:
            errorString = e.error['message']
        ...
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_3, FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
            node1_bal = node1_bal - CERT_FEE
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        mark_logs("Node 1 sends cert of quality {} with bwt of {} coins for Node2 pubkeyhash".format(quality, amount_cert_3[0]["amount"]), self.nodes, DEBUG_MODE)
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_3, FT_SC_FEE, MBTR_SC_FEE, 3*CERT_FEE)
        ...
        try:
            cert_epoch_1_4 = self.nodes[0].send_certificate(scid, epoch_number, quality_h, epoch_block_hash, proof, amount_cert_4, FT_SC_FEE, MBTR_SC_FEE, 2*CERT_FEE)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
            assert(False)
        ...
        mark_logs("Node 1 sends cert of quality {} with bwt of {} coins for Node2 pubkeyhash".format(quality, amount_cert_3[0]["amount"]), self.nodes, DEBUG_MODE)
        try:
            cert_epoch_1_3 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_3, FT_SC_FEE, MBTR_SC_FEE, 2*CERT_FEE)
        ...
        try:
            cert_epoch_2_5 = self.nodes[1].send_certificate(scid, epoch_number, quality, epoch_block_hash, proof, amount_cert_5, FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
            node1_bal = node1_bal - CERT_FEE
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
