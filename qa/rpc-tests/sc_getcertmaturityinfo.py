...
class sc_getcertmaturityinfo(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        mark_logs("Node 0 generates another certificate for each ceasing sidechain", self.nodes, DEBUG_MODE)
        ...
        for cert in [cert1_sc3, cert2_sc1, cert2_sc2]:
