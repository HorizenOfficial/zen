...
class WalletMergeToAddressTest (BitcoinTestFramework):
    overall_quantity = 100

    def copy_data_to_data_dir(self, data_dir_to_copy):
        copy_tree(data_dir_to_copy, self.options.tmpdir)
    ...
    def setup_chain(self):
        self.copy_data_to_data_dir("/tmp/testnotes" + str(self.overall_quantity).zfill(3))
