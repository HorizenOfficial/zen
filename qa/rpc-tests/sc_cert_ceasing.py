...
class sc_cert_ceasing(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            quality = 1
            proof = mcTest.create_test_proof("sc1", scids_swapped[0], epoch_number, quality, MBTR_SC_FEE, FT_SC_FEE, constant, epoch_cum_tree_hash, [pkh_node1], [bwt_amount[0]])
        ...
        try:
            #Create proof for WCert
            quality = 1
            proof = mcTest.create_test_proof("sc2", scids_swapped[1], epoch_number, quality, MBTR_SC_FEE, FT_SC_FEE, constant, epoch_cum_tree_hash, [], [])
