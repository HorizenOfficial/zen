...
class sc_cert_ceasing(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            cert_1 = self.nodes[0].send_certificate(scids[0], epoch_number, quality, epoch_block_hash, proof, amounts, FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
        ...
        try:
            ...
            cert_2 = self.nodes[0].send_certificate(scids[1], epoch_number, quality, epoch_block_hash, proof, [], FT_SC_FEE, MBTR_SC_FEE, CERT_FEE)
