...
class CertMempoolCleanupSplit(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        proof = certMcTest.create_test_proof("sc1", scid_swapped, epoch_number, quality, MBTR_SC_FEE, FT_SC_FEE, constant, epoch_cum_tree_hash, [addr_node1], [bt_amount])
        ...
        csw_proof = cswMcTest.create_test_proof(
                "csw1", sc_csw_amount, str(scid_swapped), null, csw_mc_address, ceasingCumScTxCommTree, actCertData)
