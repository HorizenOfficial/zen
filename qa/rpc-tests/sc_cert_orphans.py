...
class sc_cert_orphans(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        vk_1 = generate_params(self.options.tmpdir, scid_1)
        constant_1 = generate_random_field_element_hex()

        vk_2 = generate_params(self.options.tmpdir, scid_2)
        ...
        proof = create_test_proof(
            self.options.tmpdir, scid_1, epoch_number, epoch_block_hash, prev_epoch_block_hash,
        ...
        quality = 0
        proof = create_test_proof(
            self.options.tmpdir, scid_2, epoch_number, epoch_block_hash, prev_epoch_block_hash,
            quality, constant_2, [], [])
