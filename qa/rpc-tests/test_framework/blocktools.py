...
# regtest p2sh addresses, as of now they do not change across forks
# ---
found_addr = bytearray([
    0xb6, 0x86, 0x3b, 0x18, 0x2a, 0x52, 0x74, 0x5b,
    0xf6, 0xd5, 0xfb, 0x19, 0x01, 0x39, 0xa2, 0xaa,
    0x87, 0x6c, 0x08, 0xf5])

supn_addr = bytearray([
    0x48, 0xa1, 0xd2, 0xff, 0x60, 0x28, 0x70, 0xb0,
    0x4c, 0x8b, 0xc5, 0xd7, 0xa9, 0x3d, 0xe3, 0xa6,
    0x03, 0x33, 0x73, 0xb3])

secn_addr = bytearray([
    0x56, 0x81, 0xd2, 0x34, 0xdb, 0x93, 0x0d, 0x56,
    0xb8, 0x7f, 0x25, 0xa4, 0x67, 0x24, 0xe5, 0x40,
    0x3e, 0x84, 0xcd, 0x7c])
