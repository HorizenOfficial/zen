...
class sc_cert_base(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, proof, amounts, CERT_FEE)
            assert(False)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number + 1, quality, epoch_block_hash, epoch_cum_tree_hash, proof, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality - 100, epoch_block_hash, epoch_cum_tree_hash, proof, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, "aa" * (SC_PROOF_SIZE - 1), amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, "aa" * SC_PROOF_SIZE, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, proof_wrong, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, wrong_proof, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, eph_wrong, epoch_cum_tree_hash, proof, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        epoch_cum_tree_hash_wrong = self.nodes[0].getblock(str(200))['scCumTreeHash']
        mark_logs("Node 0 tries to send a certificate with an invalid end epoch cumulative tree hash ...", self.nodes, DEBUG_MODE)
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash_wrong, proof, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            cert_epoch_0 = self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, proof, amount_cert_1, CERT_FEE)
        ...
        try:
            self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, proof2, amount_cert_1, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        nullFee = Decimal("0.0")
        try:
            cert_epoch_1 = self.nodes[0].send_certificate(scid, epoch_number, quality, epoch_block_hash, epoch_cum_tree_hash, proof, amount_cert_2, nullFee)
        ...
        amounts = []
        try:
            self.nodes[0].send_certificate(scid, epoch_number_0, 0, epoch_block_hash_0, epoch_cum_tree_hash_0, proof, amounts, CERT_FEE)
            assert(False)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
