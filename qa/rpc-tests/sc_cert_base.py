...
class sc_cert_base(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(retrieved_cert['details'][0]['amount'], 0) # Where the bwt amount be retrieved?
        ...
        assert_equal(retrieved_cert['amount'],               amount_cert_1[0]["amount"])  # Certificate amount is not mature yet
