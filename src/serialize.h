 ...
 * optional
 */
template<typename T> unsigned int GetSerializeSize(const std::optional<T> &item, int nType, int nVersion);
template<typename Stream, typename T> void Serialize(Stream& os, const std::optional<T>& item, int nType, int nVersion);
template<typename Stream, typename T> void Unserialize(Stream& is, std::optional<T>& item, int nType, int nVersion);
