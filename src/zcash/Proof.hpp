...
class Fq {
  ...
  public:
    ...
    friend bool operator==(const Fq& a, const Fq& b) { return (a.data == b.data); }
...
class Fq2 {
  ...
  public:
    ...
    friend bool operator==(const Fq2& a, const Fq2& b) { return (a.data == b.data); }
...
class CompressedG1 {
  ...
  public:
    ...
    friend bool operator==(const CompressedG1& a, const CompressedG1& b) { return (a.y_lsb == b.y_lsb && a.x == b.x); }

    friend bool operator!=(const CompressedG1& a, const CompressedG1& b) { return !(a == b); }
};
...
class CompressedG2 {
  ...
  public:
    ...
    friend bool operator==(const CompressedG2& a, const CompressedG2& b) { return (a.y_gt == b.y_gt && a.x == b.x); }

    friend bool operator!=(const CompressedG2& a, const CompressedG2& b) { return !(a == b); }
};
...
class PHGRProof {
  ...
  public:
    ...
    friend bool operator==(const PHGRProof& a, const PHGRProof& b) {
        return (a.g_A == b.g_A && a.g_A_prime == b.g_A_prime && a.g_B == b.g_B && a.g_B_prime == b.g_B_prime &&
                a.g_C == b.g_C && a.g_C_prime == b.g_C_prime && a.g_K == b.g_K && a.g_H == b.g_H);
    }
...
class ProofVerifier {
  ...
  public:
    ...
    template <typename VerificationKey, typename ProcessedVerificationKey, typename PrimaryInput, typename Proof>
    bool check(const VerificationKey& vk, const ProcessedVerificationKey& pvk, const PrimaryInput& pi, const Proof& p);
