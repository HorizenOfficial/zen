...
static void secp256k1_num_copy(secp256k1_num* r, const secp256k1_num* a) { *r = *a; }
...
static int secp256k1_num_is_one(const secp256k1_num* a) { return (a->limbs == 1 && a->data[0] == 1); }

static int secp256k1_num_is_zero(const secp256k1_num* a) { return (a->limbs == 1 && a->data[0] == 0); }

static int secp256k1_num_is_neg(const secp256k1_num* a) { return (a->limbs > 1 || a->data[0] != 0) && a->neg; }
...
static void secp256k1_num_negate(secp256k1_num* r) { r->neg ^= 1; }
