...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Sicash sic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sicash transaction") + "\n" +
              "  sic-tx [options] -create [commands]   " + _("Create hex-encoded sicash transaction") + "\n" +
              "\n";
