...
BOOST_AUTO_TEST_CASE(get_next_work) {
    ...
    BOOST_CHECK_EQUAL(0x1d011998, CalculateNextWorkRequired(bnAvg, nThisTime, nLastRetargetTime, params));
}
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit) {
    ...
    BOOST_CHECK_EQUAL(0x1f07ffff, CalculateNextWorkRequired(bnAvg, nThisTime, nLastRetargetTime, params));
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual) {
    ...
    BOOST_CHECK_EQUAL(0x1c04bceb, CalculateNextWorkRequired(bnAvg, nThisTime, nLastRetargetTime, params));
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual) {
    ...
    BOOST_CHECK_EQUAL(0x1c4a93bb, CalculateNextWorkRequired(bnAvg, nThisTime, nLastRetargetTime, params));
}
