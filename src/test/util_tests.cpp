...
BOOST_AUTO_TEST_CASE(test_FormatSubVersion)
{
    ...
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 99951, std::vector<std::string>()), std::string("/Test:0.9.99-alpha1/"));
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 99999, std::vector<std::string>()), std::string("/Test:0.9.99-alpha49/"));
    ...
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 99924, comments2), std::string("/Test:0.9.99-beta25(comment1; comment2)/"));
    ...
    BOOST_CHECK_EQUAL(FormatSubVersion("Test", 99951, comments2), std::string("/Test:0.9.99-alpha1(comment1; comment2)/"));
}
