...
BOOST_AUTO_TEST_CASE(test_simple_sapling_invalidity)
{
	printf("test test_simple_sapling_invalidity\n");
    CMutableTransaction tx;
...
BOOST_AUTO_TEST_CASE(test_big_overwinter_transaction) {
    ...
    for(uint32_t i = 0; i < mtx.vin.size(); i++) {
        ...
        CScriptCheck check(coins, tx, i, nullptr, SCRIPT_VERIFY_P2SH, false, &txdata);
