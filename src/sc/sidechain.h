...
class CSidechainEvents {
  public:
    ...
    inline bool operator==(const CSidechainEvents& rhs) const {
        return (this->sidechainEventsVersion == rhs.sidechainEventsVersion) && (this->ceasingScs == rhs.ceasingScs) &&
...
class CSidechain {
  public:
    ...
    bool IsNull() const {
        return (creationBlockHeight == -1 && creationTxHash.IsNull() && pastEpochTopQualityCertView.IsNull() &&
                lastTopQualityCertView.IsNull() && lastTopQualityCertHash.IsNull() &&
                lastTopQualityCertReferencedEpoch == CScCertificate::EPOCH_NULL &&
                lastTopQualityCertQuality == CScCertificate::QUALITY_NULL && lastTopQualityCertBwtAmount == 0 && balance == 0 &&
                fixedParams.IsNull() && mImmatureAmounts.empty()) &&
               scFees.empty();
    }
    ...
    inline bool operator==(const CSidechain& rhs) const {
        return (this->creationBlockHeight == rhs.creationBlockHeight) && (this->creationTxHash == rhs.creationTxHash) &&
               ...
               (this->lastTopQualityCertBwtAmount == rhs.lastTopQualityCertBwtAmount) && (this->balance == rhs.balance) &&
               (this->fixedParams == rhs.fixedParams) && (this->mImmatureAmounts == rhs.mImmatureAmounts) &&
    ...
    bool isCreationConfirmed() const { return this->creationBlockHeight != -1; }
