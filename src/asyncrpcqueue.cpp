 ...
 */
bool AsyncRPCQueue::isClosed() const { return closed_.load(); }
 ...
 */
bool AsyncRPCQueue::isFinishing() const { return finish_.load(); }

/**
 * Close the queue but finish existing operations. Do not accept new operations.
 */
void AsyncRPCQueue::finish() { finish_.store(true); }
