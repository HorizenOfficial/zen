...
class CBaseRegTestParams : public CBaseTestNetParams {
  public:
    CBaseRegTestParams() { strDataDir = "regtest"; }
};
...
class CBaseUnitTestParams : public CBaseMainParams {
  public:
    CBaseUnitTestParams() { strDataDir = "unittest"; }
};
...
CBaseChainParams::Network NetworkIdFromCommandLine() {
    ...
    if (fTestNet && fRegTest) return CBaseChainParams::MAX_NETWORK_TYPES;
