...
//       nMinerThreads = 0;
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            ( 1471400, uint256S("0x0000000000be6da3d4721d4e1115dbb93f4c437ddb2d5a8f817c5349438c770a")),
            1702554028,     // * UNIX timestamp of last checkpoint block
            37855160,       // * total number of transactions between genesis and last checkpoint
                            //   (the tx=... number in the SetBestChain debug.log lines)
            14819           // * estimated number of transactions per day after checkpoint
...
//        nMinerThreads = 0;
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            ( 1385200, uint256S("0x0003663d7d2c2fde1c2a0d57d3e256ad0b336aca266e20b747b9a4795089ebcd")),
            1702550524,     // * UNIX timestamp of last checkpoint block
            2315881,        // * total number of transactions between genesis and last checkpoint
                            //   (the tx=... number in the SetBestChain debug.log lines)
            963             // * estimated number of transactions per day after checkpoint
                            //   total number of tx / (checkpoint block height / (24 * 24))
        };
