...
//       nMinerThreads = 0;
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            ( 1774100, uint256S("0x0000000005385906c9cd36bd02101b643a0c99c4ea144e8c87392b598926a51e")),
            1748239625,     // * UNIX timestamp of last checkpoint block
            38533873,       // * total number of transactions between genesis and last checkpoint
                            //   (the tx=... number in the SetBestChain debug.log lines)
            12511           // * estimated number of transactions per day after checkpoint
...
//        nMinerThreads = 0;
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            ...
            ( 1688300, uint256S("0x0000478da67a73aec1fba00cbf8f7f2f762930bdf0084e44d4ab5dc84bdc81ad")),
            1748232906,     // * UNIX timestamp of last checkpoint block
            2640936,        // * total number of transactions between genesis and last checkpoint
                            //   (the tx=... number in the SetBestChain debug.log lines)
            901             // * estimated number of transactions per day after checkpoint
                            //   total number of tx / (checkpoint block height / (24 * 24))
        };
