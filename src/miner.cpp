...
//TODO CHECK
        ...
        while (!vecPriority.empty())
        {
            ...
            if (!ContextualCheckInputs(tx, state, view, true, chainActive, MANDATORY_SCRIPT_VERIFY_FLAGS | SCRIPT_VERIFY_CHECKBLOCKATHEIGHT, true, txdata, Params().GetConsensus()))
                continue;
