...
bool CScript::IsPayToPublicKeyHash() const {
    ...
    bool p2pkh = (this->size() == 25 && (*this)[0] == OP_DUP && (*this)[1] == OP_HASH160 && (*this)[2] == 0x14 &&
    ...
    bool p2pkhWithReplay =
        (this->size() > 25 && this->size() < 65 && (*this)[0] == OP_DUP && (*this)[1] == OP_HASH160 && (*this)[2] == 0x14 &&
         (*this)[23] == OP_EQUALVERIFY && (*this)[24] == OP_CHECKSIG && (*this)[this->size() - 1] == OP_CHECKBLOCKATHEIGHT);
...
bool CScript::IsPayToScriptHash() const {
    ...
    // Check if this script is P2SH without OP_CHECKBLOCKATHEIGHT
    bool p2sh = (this->size() == 23 && this->at(0) == OP_HASH160 && this->at(1) == 0x14 && this->at(22) == OP_EQUAL);
    ...
    bool p2shWithReplay = (this->size() > 23 && this->size() < 63 && this->at(0) == OP_HASH160 && this->at(1) == 0x14 &&
                           this->at(22) == OP_EQUAL && this->at(this->size() - 1) == OP_CHECKBLOCKATHEIGHT);
...
CScript::ScriptType CScript::GetType() const {
    if (this->IsPayToPublicKeyHash()) return CScript::P2PKH;
    if (this->IsPayToScriptHash()) return CScript::P2SH;
