...
namespace {
    ...
    class DBIter : public Iterator {
      ...
      private:
        ...
        ssize_t RandomPeriod() { return rnd_.Uniform(2 * config::kReadBytesPeriod); }
...
Iterator* NewDBIterator(DBImpl* db, const Comparator* user_key_comparator, Iterator* internal_iter, SequenceNumber sequence,
                        uint32_t seed) {
