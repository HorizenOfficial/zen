...
TEST_F(ProcessTxBaseMsgTestSuite, ValidTxIsRelayed)
{
    ...
    FakeNode sourceNode{};
    addTxBaseMsgToProcess(validTx, &sourceNode);

    //test
    ProcessTxBaseMsg(fakedMemProcessor);
...
TEST_F(ProcessTxBaseMsgTestSuite, MissingInputsNonJoinsplitTxIsNotRelayed)
{
    ...
    FakeNode sourceNode{};
    addTxBaseMsgToProcess(orphanNonJoinsplitTx, &sourceNode);
...
TEST_F(ProcessTxBaseMsgTestSuite, MissingInputsJoinsplitTxIsNotRelayed)
{
    ...
    FakeNode sourceNode{};
    addTxBaseMsgToProcess(orphanJoinsplitTx, &sourceNode);
...
TEST_F(ProcessTxBaseMsgTestSuite, InvalidZeroDosTxIsNotRelayed)
{
    ...
    FakeNode sourceNode{};
    addTxBaseMsgToProcess(invalidZeroDoSTx, &sourceNode);
...
TEST_F(ProcessTxBaseMsgTestSuite, InvalidHighDosTxIsNotRelayed)
{
    ...
    FakeNode sourceNode{};
    addTxBaseMsgToProcess(invalidHighDoSTx, &sourceNode);
...
TEST_F(ProcessTxBaseMsgTestSuite, OrphanTxesTurningValidAreRelayed)
{
    ...
    addTxBaseMsgToProcess(orphanTx_1, &sourceNode);
    ProcessTxBaseMsg(fakedMemProcessor);
    ASSERT_TRUE(mapRelay.count(CInv(MSG_TX, orphanTx_1.GetHash())) == 0);

    addTxBaseMsgToProcess(orphanTx_2, &sourceNode);
    ProcessTxBaseMsg(fakedMemProcessor);
...
TEST_F(ProcessTxBaseMsgTestSuite, OrphanTxesTurningZeroDosInvalidAreNotRelayed)
{
    ...
    addTxBaseMsgToProcess(invalidMissingInputsTx, &sourceNode);
    ProcessTxBaseMsg(fakedMemProcessor);
