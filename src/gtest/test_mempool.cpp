...
TEST(Mempool, TxInputLimit) {
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state2, tx1, LimitFreeFlag::OFF, &missingInputs, RejectAbsurdFeeFlag::OFF, DisconnectingFlag::OFF));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state3, tx3, LimitFreeFlag::OFF, &missingInputs, RejectAbsurdFeeFlag::OFF, DisconnectingFlag::OFF));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state4, tx3, LimitFreeFlag::OFF, &missingInputs, RejectAbsurdFeeFlag::OFF, DisconnectingFlag::OFF));
