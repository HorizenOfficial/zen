...
TEST(Mempool, TxInputLimit) {
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state1, tx1, eLimitFree::OFF, &missingInputs, eDisconnecting::OFF, eRejectAbsurdFee::OFF));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state2, tx1, eLimitFree::OFF, &missingInputs, eDisconnecting::OFF, eRejectAbsurdFee::OFF));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state3, tx3, eLimitFree::OFF, &missingInputs, eDisconnecting::OFF, eRejectAbsurdFee::OFF));
