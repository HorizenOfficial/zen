...
// Sprout transaction version 3 when Groth is not active:
...
TEST(Mempool, testCheckReferencedHeight)
{
    CTxMemPool aMempool(::minRelayTxFee);

    uint256 heights[] = { uint256S("aaa"), uint256S("bbb"), uint256S("ccc"), uint256S("ddd"), uint256S("eee") };
    mapCumtreeHeight.insert(std::make_pair(heights[0], 1));
    mapCumtreeHeight.insert(std::make_pair(heights[1], 2));
    mapCumtreeHeight.insert(std::make_pair(heights[2], 3));
    ...
    // ###### WRONG CERTIFICATE, EP 1, REF 0, Q 0 ######
    cert = txCreationUtils::createCertificate(uint256S("foo1"), /*epochNum*/1,
            CFieldElement(heights[0]), /*changeTotalAmount*/0, /*numChangeOut*/0, /*bwtTotalAmount*/0,
            /*numBwt*/4, /*ftScFee*/0, /*mbtrScFee*/0, /*quality*/0);
    ...
    // ###### WRONG CERTIFICATE, EP 2, REF 1, Q 0 ###### (ref precedes epoch 1)
    cert = txCreationUtils::createCertificate(uint256S("foo3"), /*epochNum*/2,
            CFieldElement(heights[1]), /*changeTotalAmount*/0, /*numChangeOut*/0, /*bwtTotalAmount*/0,
            /*numBwt*/4, /*ftScFee*/0, /*mbtrScFee*/0, /*quality*/0);
    ASSERT_FALSE(aMempool.checkReferencedHeight(cert));
    ...
    cert = txCreationUtils::createCertificate(uint256S("foo3"), /*epochNum*/2,
            CFieldElement(heights[3]), /*changeTotalAmount*/0, /*numChangeOut*/0, /*bwtTotalAmount*/0,
            /*numBwt*/4, /*ftScFee*/0, /*mbtrScFee*/0, /*quality*/0);
    ASSERT_TRUE(aMempool.checkReferencedHeight(cert));
