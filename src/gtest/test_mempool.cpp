...
TEST(Mempool, TxInputLimit) {
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state1, tx1, false, &missingInputs, /*disconnecting*/false));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state2, tx1, false, &missingInputs, /*disconnecting*/false));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state3, tx3, false, &missingInputs, /*disconnecting*/false));
    ...
    EXPECT_FALSE(AcceptTxToMemoryPool(pool, state4, tx3, false, &missingInputs, /*disconnecting*/false));
