...
TEST(ForkManager, GetCommunityFundAddressRegtest) {
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(101 - 1, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(101, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(101 + 1, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");

    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105 - 1, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105 + 1, 840000, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(450 - 1, 0, foundation),
              "zrQWJd1fhtkQtrjbYPXfHFF1c61DUtiXcCD");
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(INT_MAX, 0, foundation),
              "zrLaR63UYCHVvo5BJHoMUTuZFPmcUu866wB");
}
...
TEST(ForkManager, GetCommunityFundAddressTestnet) {
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(70001, 840000, Fork::CommunityFundType::FOUNDATION),
              "zrBAG3pXCTDq14nivNK9mW8SfwMNcdmMQpb");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(85499, 840000, Fork::CommunityFundType::FOUNDATION),
              "zrRLwpYRYky4wsvwLVrDp8fs89EBTRhNMB1");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(85500, 840000, Fork::CommunityFundType::FOUNDATION),
              "zrRBQ5heytPMN5nY3ssPf3cG4jocXeD8fm1");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(260499, 840000, Fork::CommunityFundType::FOUNDATION),
              "zrRBQ5heytPMN5nY3ssPf3cG4jocXeD8fm1");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(260500, 840000, Fork::CommunityFundType::FOUNDATION),
              "zrFzxutppvxEdjyu4QNjogBMjtC1py9Hp1S");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 - 1, 0, Fork::CommunityFundType::FOUNDATION),
              "zrFzxutppvxEdjyu4QNjogBMjtC1py9Hp1S");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900, 0, Fork::CommunityFundType::FOUNDATION),
              "zrFwQjR613EuvLSufoNvUzZrfKvjSQx5a23");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 + 1, 0, Fork::CommunityFundType::FOUNDATION),
              "zrFwQjR613EuvLSufoNvUzZrfKvjSQx5a23");

    // Test the highest possible block (for spotting potential regressions)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(INT_MAX, 0, Fork::CommunityFundType::FOUNDATION),
              "zrFwQjR613EuvLSufoNvUzZrfKvjSQx5a23");
}
...
TEST(ForkManager, GetCommunityFundAddressMainnet) {
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(110001, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsmncLmwEUdVmAGPUrUnNKmPGXyej7mbmdM");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(122506, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsmncLmwEUdVmAGPUrUnNKmPGXyej7mbmdM");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(122507, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsfa9VVJCEdjfPbku4XrFcRR8kTDm2T64rz");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(139199, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsfa9VVJCEdjfPbku4XrFcRR8kTDm2T64rz");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(139200, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsyF68hcYYNLPj5i4PfQJ1kUY6nsFnZkc82");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(189199, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsyF68hcYYNLPj5i4PfQJ1kUY6nsFnZkc82");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(189200, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsfULrmbX7xbhqhAFRffVqCw9RyGv2hqNNG");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(239199, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsfULrmbX7xbhqhAFRffVqCw9RyGv2hqNNG");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(239200, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsoemTfqjicem2QVU8cgBHquKb1o9JR5p4Z");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(289199, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsoemTfqjicem2QVU8cgBHquKb1o9JR5p4Z");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(289200, 840000, Fork::CommunityFundType::FOUNDATION),
              "zt339oiGL6tTgc9Q71f5g1sFTZf6QiXrRUr");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(339199, 840000, Fork::CommunityFundType::FOUNDATION),
              "zt339oiGL6tTgc9Q71f5g1sFTZf6QiXrRUr");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(339200, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsyF68hcYYNLPj5i4PfQJ1kUY6nsFnZkc82");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(344699, 840000, Fork::CommunityFundType::FOUNDATION),
              "zsyF68hcYYNLPj5i4PfQJ1kUY6nsFnZkc82");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(344700, 840000, Fork::CommunityFundType::FOUNDATION),
              "zszpcLB6C5B8QvfDbF2dYWXsrpac5DL9WRk");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000 - 1, 0, Fork::CommunityFundType::FOUNDATION),
              "zszpcLB6C5B8QvfDbF2dYWXsrpac5DL9WRk");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000, 0, Fork::CommunityFundType::FOUNDATION),
...
TEST(ForkManager, GetSecureNodeFundAddressRegtest) {
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105, 840000, securenode),
              "zrQG6x9j33DLbCfzAqu3qKMe7z1VDL1z2L7");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105 + 1, 840000, securenode),
              "zrQG6x9j33DLbCfzAqu3qKMe7z1VDL1z2L7");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(450 - 1, 0, securenode),
              "zrQG6x9j33DLbCfzAqu3qKMe7z1VDL1z2L7");
    ...
    // Test the highest possible block (for spotting potential regressions)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(INT_MAX, 0, securenode),
              "zrPaU1KWpNrg5fcLsSk17z7cc71FvnVnXxi");
}

TEST(ForkManager, GetSecureNodeFundAddressTestnet) {
    SelectParams(CBaseChainParams::TESTNET);
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(260500, 840000, Fork::CommunityFundType::SECURENODE),
              "zrS7QUB2eDbbKvyP43VJys3t7RpojW8GdxH");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 - 1, 0, Fork::CommunityFundType::SECURENODE),
              "zrS7QUB2eDbbKvyP43VJys3t7RpojW8GdxH");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900, 0, Fork::CommunityFundType::SECURENODE),
              "zrQM7AZ1qpm9TPzLc2YinGhWePt7vaHz4Rg");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 + 1, 0, Fork::CommunityFundType::SECURENODE),
              "zrQM7AZ1qpm9TPzLc2YinGhWePt7vaHz4Rg");

    // Test the highest possible block (for spotting potential regressions)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(INT_MAX, 0, Fork::CommunityFundType::SECURENODE),
              "zrQM7AZ1qpm9TPzLc2YinGhWePt7vaHz4Rg");
}

TEST(ForkManager, GetSecureNodeFundAddressMainnet) {
    SelectParams(CBaseChainParams::MAIN);
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(344700, 840000, Fork::CommunityFundType::SECURENODE),
              "zsxWnyDbU8pk2Vp98Uvkx5Nh33RFzqnCpWN");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000 - 1, 0, Fork::CommunityFundType::SECURENODE),
              "zsxWnyDbU8pk2Vp98Uvkx5Nh33RFzqnCpWN");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000, 0, Fork::CommunityFundType::SECURENODE),
...
TEST(ForkManager, GetSuperNodeFundAddressRegtest) {
    ...
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(105, 840000, supernode),
...
TEST(ForkManager, GetSuperNodeFundAddressTestnet) {
    SelectParams(CBaseChainParams::TESTNET);
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(260500, 840000, Fork::CommunityFundType::SUPERNODE),
              "zrFr5HVm7woVq3oFzkMEdJdbfBchfPAPDsP");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 - 1, 0, Fork::CommunityFundType::SUPERNODE),
              "zrFr5HVm7woVq3oFzkMEdJdbfBchfPAPDsP");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900, 0, Fork::CommunityFundType::SUPERNODE),
              "zrSRNSqeBNEtXqn8NkAgJ9gwhLTJmXjKqoX");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1028900 + 1, 0, Fork::CommunityFundType::SUPERNODE),
              "zrSRNSqeBNEtXqn8NkAgJ9gwhLTJmXjKqoX");

    // Test the highest possible block (for spotting potential regressions)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(INT_MAX, 0, Fork::CommunityFundType::SUPERNODE),
              "zrSRNSqeBNEtXqn8NkAgJ9gwhLTJmXjKqoX");
}

TEST(ForkManager, GetSuperNodeFundAddressMainnet) {
    SelectParams(CBaseChainParams::MAIN);
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(344700, 840000, Fork::CommunityFundType::SUPERNODE),
              "zsnL6pKdzvZ1BPVzALUoqw2KsY966XFs5CE");

    // Test the new addresses introduced in the hard fork 9 (sidechain version)
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000 - 1, 0, Fork::CommunityFundType::SUPERNODE),
              "zsnL6pKdzvZ1BPVzALUoqw2KsY966XFs5CE");
    EXPECT_EQ(ForkManager::getInstance().getCommunityFundAddress(1127000, 0, Fork::CommunityFundType::SUPERNODE),
