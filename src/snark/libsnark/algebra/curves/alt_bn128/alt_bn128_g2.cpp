...
void alt_bn128_G2::print() const {
    if (this->is_zero()) {
        ...
        gmp_printf("(%Nd*z + %Nd , %Nd*z + %Nd)\n", copy.X.c1.as_bigint().data, alt_bn128_Fq::num_limbs,
                   copy.X.c0.as_bigint().data, alt_bn128_Fq::num_limbs, copy.Y.c1.as_bigint().data, alt_bn128_Fq::num_limbs,
...
void alt_bn128_G2::print_coordinates() const {
    if (this->is_zero()) {
        ...
        gmp_printf("(%Nd*z + %Nd : %Nd*z + %Nd : %Nd*z + %Nd)\n", this->X.c1.as_bigint().data, alt_bn128_Fq::num_limbs,
                   this->X.c0.as_bigint().data, alt_bn128_Fq::num_limbs, this->Y.c1.as_bigint().data, alt_bn128_Fq::num_limbs,
                   this->Y.c0.as_bigint().data, alt_bn128_Fq::num_limbs, this->Z.c1.as_bigint().data, alt_bn128_Fq::num_limbs,
...
bool alt_bn128_G2::is_special() const { return (this->is_zero() || this->Z == alt_bn128_Fq2::one()); }
...
bool alt_bn128_G2::operator!=(const alt_bn128_G2& other) const { return !(operator==(other)); }
...
alt_bn128_G2 alt_bn128_G2::operator-() const { return alt_bn128_G2(this->X, -(this->Y), this->Z); }

alt_bn128_G2 alt_bn128_G2::operator-(const alt_bn128_G2& other) const { return (*this) + (-other); }
...
alt_bn128_G2 alt_bn128_G2::mul_by_q() const {
    return alt_bn128_G2(alt_bn128_twist_mul_by_q_X * (this->X).Frobenius_map(1),
                        alt_bn128_twist_mul_by_q_Y * (this->Y).Frobenius_map(1), (this->Z).Frobenius_map(1));
}
...
alt_bn128_G2 alt_bn128_G2::random_element() { return (alt_bn128_Fr::random_element().as_bigint()) * G2_one; }
