...
void alt_bn128_G1::print() const {
    if (this->is_zero()) {
        ...
        gmp_printf("(%Nd , %Nd)\n", copy.X.as_bigint().data, alt_bn128_Fq::num_limbs, copy.Y.as_bigint().data,
...
void alt_bn128_G1::print_coordinates() const {
    if (this->is_zero()) {
        ...
        gmp_printf("(%Nd : %Nd : %Nd)\n", this->X.as_bigint().data, alt_bn128_Fq::num_limbs, this->Y.as_bigint().data,
                   alt_bn128_Fq::num_limbs, this->Z.as_bigint().data, alt_bn128_Fq::num_limbs);
    }
}
...
bool alt_bn128_G1::is_special() const { return (this->is_zero() || this->Z == alt_bn128_Fq::one()); }
...
bool alt_bn128_G1::operator!=(const alt_bn128_G1& other) const { return !(operator==(other)); }
...
alt_bn128_G1 alt_bn128_G1::operator-() const { return alt_bn128_G1(this->X, -(this->Y), this->Z); }

alt_bn128_G1 alt_bn128_G1::operator-(const alt_bn128_G1& other) const { return (*this) + (-other); }
...
alt_bn128_G1 alt_bn128_G1::random_element() { return (scalar_field::random_element().as_bigint()) * G1_one; }
