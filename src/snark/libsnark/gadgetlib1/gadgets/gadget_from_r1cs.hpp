...
class gadget_from_r1cs : public gadget<FieldT> {
  ...
  public:
    gadget_from_r1cs(protoboard<FieldT>& pb, const std::vector<pb_variable_array<FieldT> >& vars,
                     const r1cs_constraint_system<FieldT>& cs, const std::string& annotation_prefix);
