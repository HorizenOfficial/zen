...
void generate_boolean_r1cs_constraint(protoboard<FieldT>& pb, const pb_linear_combination<FieldT>& lc,
                                      const std::string& annotation_prefix = "");

template <typename FieldT>
void generate_r1cs_equals_const_constraint(protoboard<FieldT>& pb, const pb_linear_combination<FieldT>& lc, const FieldT& c,
                                           const std::string& annotation_prefix = "");
...
class packing_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    packing_gadget(protoboard<FieldT>& pb, const pb_linear_combination_array<FieldT>& bits,
                   const pb_linear_combination<FieldT>& packed, const std::string& annotation_prefix = "")
...
class multipacking_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    multipacking_gadget(protoboard<FieldT>& pb, const pb_linear_combination_array<FieldT>& bits,
                        const pb_linear_combination_array<FieldT>& packed_vars, const size_t chunk_size,
                        const std::string& annotation_prefix = "");
    void generate_r1cs_constraints(const bool enforce_bitness);
    void generate_r1cs_witness_from_packed();
    void generate_r1cs_witness_from_bits();
...
class field_vector_copy_gadget : public gadget<FieldT> {
  public:
    ...
    field_vector_copy_gadget(protoboard<FieldT>& pb, const pb_variable_array<FieldT>& source,
                             const pb_variable_array<FieldT>& target, const pb_linear_combination<FieldT>& do_copy,
                             const std::string& annotation_prefix = "");
...
class bit_vector_copy_gadget : public gadget<FieldT> {
  public:
    ...
    bit_vector_copy_gadget(protoboard<FieldT>& pb, const pb_variable_array<FieldT>& source_bits,
                           const pb_variable_array<FieldT>& target_bits, const pb_linear_combination<FieldT>& do_copy,
                           const size_t chunk_size, const std::string& annotation_prefix = "");
...
class dual_variable_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    dual_variable_gadget(protoboard<FieldT>& pb, const size_t width, const std::string& annotation_prefix = "")
        ...
        consistency_check.reset(
            new packing_gadget<FieldT>(pb, bits, packed, FMT(this->annotation_prefix, " consistency_check")));
    }

    dual_variable_gadget(protoboard<FieldT>& pb, const pb_variable_array<FieldT>& bits,
                         const std::string& annotation_prefix = "")
    ...
    dual_variable_gadget(protoboard<FieldT>& pb, const pb_variable<FieldT>& packed, const size_t width,
                         const std::string& annotation_prefix = "")
...
class disjunction_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    disjunction_gadget(protoboard<FieldT>& pb, const pb_variable_array<FieldT>& inputs, const pb_variable<FieldT>& output,
                       const std::string& annotation_prefix = "")
...
class conjunction_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    conjunction_gadget(protoboard<FieldT>& pb, const pb_variable_array<FieldT>& inputs, const pb_variable<FieldT>& output,
                       const std::string& annotation_prefix = "")
        : gadget<FieldT>(pb, annotation_prefix), inputs(inputs), output(output) {
        assert(inputs.size() >= 1);
        inv.allocate(pb, FMT(this->annotation_prefix, " inv"));
...
class comparison_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    comparison_gadget(protoboard<FieldT>& pb, const size_t n, const pb_linear_combination<FieldT>& A,
                      const pb_linear_combination<FieldT>& B, const pb_variable<FieldT>& less,
                      const pb_variable<FieldT>& less_or_eq, const std::string& annotation_prefix = "")
        ...
        all_zeros_test.reset(new disjunction_gadget<FieldT>(pb, pb_variable_array<FieldT>(alpha.begin(), alpha.begin() + n),
                                                            not_all_zeros, FMT(this->annotation_prefix, " all_zeros_test")));
    };
...
class inner_product_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    inner_product_gadget(protoboard<FieldT>& pb, const pb_linear_combination_array<FieldT>& A,
                         const pb_linear_combination_array<FieldT>& B, const pb_variable<FieldT>& result,
                         const std::string& annotation_prefix = "")
...
class loose_multiplexing_gadget : public gadget<FieldT> {
  ...
  public:
    ...
    loose_multiplexing_gadget(protoboard<FieldT>& pb, const pb_linear_combination_array<FieldT>& arr,
                              const pb_variable<FieldT>& index, const pb_variable<FieldT>& result,
                              const pb_variable<FieldT>& success_flag, const std::string& annotation_prefix = "")
        ...
        compute_result.reset(
            new inner_product_gadget<FieldT>(pb, alpha, arr, result, FMT(this->annotation_prefix, " compute_result")));
    };
...
void create_linear_combination_constraints(protoboard<FieldT>& pb, const std::vector<FieldT>& base,
                                           const std::vector<std::pair<VarT, FieldT> >& v, const VarT& target,
                                           const std::string& annotation_prefix);

template <typename FieldT, typename VarT>
void create_linear_combination_witness(protoboard<FieldT>& pb, const std::vector<FieldT>& base,
                                       const std::vector<std::pair<VarT, FieldT> >& v, const VarT& target);
